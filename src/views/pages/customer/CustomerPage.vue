...
async function _blockOrUnblockUser(user:ICheckUserAccount){
    confirmDelation('do you want to block or unblock user ?').then(async()=>{
   ...
   <div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div v-else>
                <CustomerTable @blockOrUnblockUser="_blockOrUnblockUser"  :checkUserAccountData="serverData?.data"/>
            </div>
